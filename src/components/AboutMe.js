...
const AboutParagraph = styled.p`
  ...
  @media (max-width: 600px) {
    text-align: left; // Mobile screens
  }

  @media (max-width: 400px) {
    text-align: left; // Narrow screens
  }
`;
  ...
  return (
    <section id="about">
      <div ref={aboutRef} style={{ width: '100%', maxWidth: '800px', textAlign: 'center', padding: '0 1rem' }}>
        ...
        <AboutParagraph>
    My name is Nang Hlaing Kham Oo. Most people call me my nickname "Kham". I am currently pursuing a degree in Communication Arts at Rangsit University in Thailand. Previously, I studied Business Management for two years at the National Management Degree College in Myanmar.
    <br /><br />
    ...
    <br /><br />
    I am also the owner of <strong><a href='https://web.facebook.com/profile.php?id=100064159624165' target="_blank" rel="noopener noreferrer" style={{color: 'red', textDecoration: 'none'}}>Pony</a></strong> facebook page where I sell cosmetics and clothes. <strong><a href='https://www.tiktok.com/@ponys.fashion.war6?_t=ZS-8umMCZsILoo&_r=1' target="_blank" rel="noopener noreferrer" style={{color: 'red', textDecoration: 'none'}}>Here</a> </strong>is the Tik Tok link for Pony's Wardrobe.
